...
public class MJPostdecrement extends Postdecrement_expression {

    private Postfix_expression postfix_expression;

    public MJPostdecrement (Postfix_expression postfix_expression) {
