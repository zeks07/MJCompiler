...
public class MJMultiplication extends Multiplicative_expression {

    private Multiplicative_expression multiplicative_expression;
    private Unary_expression unary_expression;

    public MJMultiplication (Multiplicative_expression multiplicative_expression, Unary_expression unary_expression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MJMultiplication(\n");
