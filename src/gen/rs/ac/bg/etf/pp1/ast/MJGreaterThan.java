...
public class MJGreaterThan extends Relational_expression {

    private Relational_expression relational_expression;
    private Additive_expression additive_expression;

    public MJGreaterThan (Relational_expression relational_expression, Additive_expression additive_expression) {
