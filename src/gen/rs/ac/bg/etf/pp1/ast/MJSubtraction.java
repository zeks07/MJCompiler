...
public class MJSubtraction extends Additive_expression {

    private Additive_expression additive_expression;
    private Multiplicative_expression multiplicative_expression;

    public MJSubtraction (Additive_expression additive_expression, Multiplicative_expression multiplicative_expression) {
