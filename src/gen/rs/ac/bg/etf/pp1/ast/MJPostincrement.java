...
public class MJPostincrement extends Postincrement_expression {

    private Postfix_expression postfix_expression;

    public MJPostincrement (Postfix_expression postfix_expression) {
