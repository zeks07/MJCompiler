...
public class MJEqual extends Equaliity_expression {

    private Equaliity_expression equaliity_expression;
    private Relational_expression relational_expression;

    public MJEqual (Equaliity_expression equaliity_expression, Relational_expression relational_expression) {
