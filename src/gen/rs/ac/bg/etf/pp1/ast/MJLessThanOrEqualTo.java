...
public class MJLessThanOrEqualTo extends Relational_expression {

    private Relational_expression relational_expression;
    private Additive_expression additive_expression;

    public MJLessThanOrEqualTo (Relational_expression relational_expression, Additive_expression additive_expression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MJLessThanOrEqualTo(\n");
