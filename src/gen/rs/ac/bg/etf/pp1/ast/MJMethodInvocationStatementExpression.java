...
public class MJMethodInvocationStatementExpression extends Statement_expression {

    private Method_invocation method_invocation;

    public MJMethodInvocationStatementExpression (Method_invocation method_invocation) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MJMethodInvocationStatementExpression(\n");
